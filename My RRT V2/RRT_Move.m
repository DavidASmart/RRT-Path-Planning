...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [GoalReached, h] = RRT_Move(StartNode, GoalNode, res, i, limit, h, k, params, dispRRT)
% params:
...
% Status (& "update")
[Crash, Goal, ClosestNode, idx, d, NewNode] = getStatus(NewNode, res, limit, params);
